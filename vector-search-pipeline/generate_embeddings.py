...
def create_index_if_not_exists():
    ...
    try:
        if not client.indices.exists(index=index_name):
            response = _client.indices.create(
...
def load_paragraphs(fname):
    ...
    for i, para in enumerate(paragraphs):
        ...
        if para_text:  # Ensure non-empty paragraphs
...
def main():
    ...
    fname = "/Users/r0j08wt/cataloguesearch/documentai_output/Kalash_Tika_02.txt"
